 ...
 */
async function deposit({ currency, amount, instance }) {
 ...
 */
 async function withdraw({ instance, deposit, currency, amount, recipient, relayerURL, refund = '0' }) {
...
module.exports = {deposit, withdraw, parseNote, init}
