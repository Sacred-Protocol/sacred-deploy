...
const SacredTreesV1 = artifacts.require('SacredTreesV1Mock')
const Sacred = artifacts.require('SACREDMock')
...
contract('Miner', (accounts) => {
  ...
  let rewardSwap
  let sacredTrees
  const sacred = '0x3535249DFBb73e21c2aCDC6e42796d920A0379b7'
  const sacredCap = toBN(sacredConfig.sacred.cap)
  const miningCap = toBN(sacredConfig.sacred.distribution.miningV2.amount)
  ...
  before(async () => {
    ...
    const sacredTreesV1 = await SacredTreesV1.new(
      0,
      0,
    ...
    sacredTrees = await SacredTrees.new(operator, sacredTreesV1.address, {
      depositsFrom: 0,
      depositsStep: 0,
      withdrawalsFrom: 0,
      withdrawalsStep: 0,
    })
    await sacredTrees.initialize(operator, verifier)
    ...
    miner = await Miner.new(
      ...
      toFixedHex(emptyTree.root()),
      [{ instance: sacred, value: RATE.toString() }],
    )
    ...
    await sacredTrees.updateRoots(toFixedHex(depositTree.root()), toFixedHex(withdrawalTree.root()))
  ...
  describe('#constructor', () => {
    it('should initialize', async () => {
      ...
      const rateFromContract = await miner.rates(sacred)
  ...
  describe('#Note.fromString()', () => {
    it('should work', () => {
      ...
      const note1 = Note.fromString(
        'sacred-eth-1-5-0x00b9787ae8b877cc612acfc3d46eb1303c618ef386cb4383b75be5b300ac9b94818f3f7a589b4667612e879dbfd44198231c86aaa412a3770fd86d8fc045',
        '0x8b3f5393bA08c24cc7ff5A66a832562aAB7bC95f',
        10,
        15,
      )
